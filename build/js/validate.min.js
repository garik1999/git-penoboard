...
class Validation {
  constructor(form, options) {
    ...
    this.options = Object.assign({
      ...
      Password: {
        ...
        minLength: Number($('input[data-MinlengthPass]').attr('data-MinlengthPass')) || 8,
        maxLength: Number($('input[data-MaxlengthPass]').attr('data-MaxlengthPass')) || 10
      },
      PasswordConfirm: {
        helpers: {
      ...
      Name: {
        ...
        minLength: Number($('input[data-MinlengthName]').attr('data-MinlengthName')) || 3,
        maxLength: Number($('input[data-MaxlengthName]').attr('data-MaxlengthName')) || 10
      },
      Surname: {
        helpers: {
        ...
        minLength: Number($('input[data-MinlengthSurname]').attr('data-MinlengthSurname')) || 3,
        maxLength: Number($('input[data-MaxlengthSurname]').attr('data-MaxlengthSurname')) || 10
      }
    }, options || {});
  ...
  initHelpers(input, valid, text = "Ошибка") {
    ...
    if (valid) {
      parentError.remove();
      input.addClass(this.options.validationClass.success).removeClass(this.options.validationClass.error);
    } else {
      if (parentError.length <= 0) {
        parent.append(`<span class="${this.options.validationClass.helpers.class}">${text}</span>`);
      }

      input.removeClass(this.options.validationClass.success).addClass(this.options.validationClass.error);
    }
  }
